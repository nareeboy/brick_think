  ...
  return (
    <>
      <button
        ...
        className="inline-flex h-10 cursor-pointer items-center justify-center rounded-xl bg-[#a8482a] px-4 text-[14px] font-semibold text-white shadow-[0_12px_24px_-12px_rgba(192,97,61,0.6)] transition-colors hover:bg-[#cf6e47]"
      >
        New design
      </button>
