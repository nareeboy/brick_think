...
export async function saveNarration(
  ...
  // The cleanup itself (Claude + the Anthropic key) is a premium overlay concern:
  // on the open core the hook is a no-op pass-through, so this degrades to raw text.
