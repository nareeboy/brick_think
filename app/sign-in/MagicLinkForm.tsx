    ...
    <form action={formAction} className="flex flex-col gap-2.5" noValidate>
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-xl border border-zinc-900/10 bg-white py-3 pl-10 pr-3.5 text-[15px] text-zinc-900 placeholder:text-zinc-400 outline-none transition-colors focus:border-zinc-900/30 focus-visible:ring-2 focus-visible:ring-[#c0613d]/40"
        />
      </div>
